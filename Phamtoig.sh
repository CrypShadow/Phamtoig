#!/bin/bash
# Dont copy this code bitch

trap 'printf "\n";partial;exit 1' 2

banner() {
printf "\e[1;95m╔═══════════════════════════════════════════════════════════════╗\e[0m\n"
printf "\e[1;95m║ \e[1;92m██████╗ ██╗  ██╗ █████╗ ███╗   ███╗████████╗ ██████╗ ██╗ ██████╗ ║\e[0m\n"
printf "\e[1;95m║ \e[1;92m██╔══██╗██║  ██║██╔══██╗████╗ ████║╚══██╔══╝██╔═══██╗██║██╔════╝ ║\e[0m\n"
printf "\e[1;95m║ \e[1;92m██████╔╝███████║███████║██╔████╔██║   ██║   ██║   ██║██║██║  ███╗║\e[0m\n"
printf "\e[1;95m║ \e[1;92m██╔═══╝ ██╔══██║██╔══██║██║╚██╔╝██║   ██║   ██║   ██║██║██║   ██║║\e[0m\n"
printf "\e[1;95m║ \e[1;92m██║     ██║  ██║██║  ██║██║ ╚═╝ ██║   ██║   ╚██████╔╝██║╚██████╔╝║\e[0m\n"
printf "\e[1;95m║ \e[1;92m╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝   ╚═╝    ╚═════╝ ╚═╝ ╚═════╝ ║\e[0m\n"
printf "\e[1;95m╠═══════════════════════════════════════════════════════════════╣\e[0m\n"
printf "\e[1;96m║   💀 Tool: Phamtoig  |  Author: CrypShadow  |  v1.0          ║\e[0m\n"
printf "\e[1;95m╚═══════════════════════════════════════════════════════════════╝\e[0m\n"
}
...
while git clone https://github.com/CrypShadow/CrypHavoc 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
...
banner
       ...
       echo ' '
   echo -e "\e[92m[\e[91m1\e[92m]\e[93m Start Finder\e[93m"
...
echo -e '\e[91m
                     ...
                     ────▌──▐────
'
echo -e "\e[93m                    CALL ME \e[92mCryp" | pv -qL 10
echo -e "\e[93m               REAL NAME \e[92mCrypShadow" | pv -qL 10
